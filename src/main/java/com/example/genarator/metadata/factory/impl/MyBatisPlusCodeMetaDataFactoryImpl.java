 ...
 */
public class MyBatisPlusCodeMetaDataFactoryImpl implements CodeMetaDataFactory {
	
	private static final MyBatisPlusCodeMetaDataFactoryImpl instance = new MyBatisPlusCodeMetaDataFactoryImpl();

	private CodeConfig codeConfig;
	
    private MyBatisPlusCodeMetaDataFactoryImpl() {
